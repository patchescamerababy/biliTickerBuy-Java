...
import com.example.task.BuyTaskCli;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if ("buy".equals(command)) {
                ...
                BuyTaskCli buyTaskCli = new BuyTaskCli(
                ...
                buyTaskCli.run(); // Run directly in main thread for command line mode
            } else {
                ...
                com.example.web.WebServer webServer = new com.example.web.WebServer();
